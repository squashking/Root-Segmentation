...
def calculate_area(pred, label, num_classes, ignore_index=255):
    ...
    for i in range(num_classes):
        ...
        pred_area.append(paddle.sum(paddle.cast(pred_i, "int32")).reshape([1]))
        label_area.append(paddle.sum(paddle.cast(label_i, "int32")).reshape([1]))
        intersect_area.append(paddle.sum(paddle.cast(intersect_i, "int32")).reshape([1]))
