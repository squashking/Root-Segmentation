...
class EMixVisionTransformer_(nn.Layer):
    def __init__(self,
                 img_size=512,
                 patch_size=16,
                 in_chans=3,
...
def EMixVisionTransformer_B0_(**kwargs):
    return EMixVisionTransformer_(
        patch_size=4,
...
@manager.BACKBONES.add_component
def EMixVisionTransformer_B1_(**kwargs):
    return EMixVisionTransformer_(
        patch_size=4,
...
@manager.BACKBONES.add_component
def EMixVisionTransformer_B2_(**kwargs):
    return EMixVisionTransformer_(
        patch_size=4,
        embed_dims=[64, 128, 320, 512],
        num_heads=[1, 2, 5, 8],
...
@manager.BACKBONES.add_component
def EMixVisionTransformer_B3_(**kwargs):
    return EMixVisionTransformer_(
        patch_size=4,
        embed_dims=[64, 128, 320, 512],
        num_heads=[1, 2, 5, 8],
...
@manager.BACKBONES.add_component
def EMixVisionTransformer_B4_(**kwargs):
    return EMixVisionTransformer_(
        patch_size=4,
        embed_dims=[64, 128, 320, 512],
        num_heads=[1, 2, 5, 8],
...
@manager.BACKBONES.add_component
def EMixVisionTransformer_B5_(**kwargs):
    return EMixVisionTransformer_(
        patch_size=4,
        embed_dims=[64, 128, 320, 512],
        num_heads=[1, 2, 5, 8],
...
if __name__ == '__main__':
    paddle.summary(EMixVisionTransformer_B0_(), (4, 3, 512, 512))
